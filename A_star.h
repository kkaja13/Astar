...
public:
    ...
    bool is_valid(Cell a) const;	//jsou-li souradnice bunky v rozsahu bludište
    ...
    void update(vector<vector<bool>> & on_border, priority_queue<Cell, vector<Cell>, greater<>> & frontier,
